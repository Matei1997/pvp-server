...
class _HudStore {
    ...
    voiceTransmitting: { local: boolean; radio: boolean } = observable.object({ local: false, radio: false });
    ...
    setVoiceTransmitting(data: { local: boolean; radio: boolean }) {
        this.voiceTransmitting.local = !!data.local;
        this.voiceTransmitting.radio = !!data.radio;
    }
    ...
    public createEvents() {
        ...
        EventManager.addHandler("voice", "transmitting", (data: { local: boolean; radio: boolean }) => this.setVoiceTransmitting(data));
