...
const InteractButton: FC<{ store: typeof hudStore }> = observer(({ store }) => {
    ...
    const buttonImage = useMemo(() => {
        const image = store.interactButton?.image ? new URL(`../../../assets/images/hud/inventory/items/${store.interactButton?.image}.svg`, import.meta.url).href : "";
        return image.includes("undefined") || !image ? new URL("../../../assets/images/hud/icons/interact.svg", import.meta.url).href : image;
