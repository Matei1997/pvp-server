...
const CEFPages: ICefPages = {
    ...
    arena_readycheck: { blur: true, radar: false, pause: false, controls: true, close: true },
    arena_hud: { blur: false, radar: true, pause: false, controls: false, close: false, cursor: false },
    ffa_lobby: { blur: true, radar: false, pause: false, controls: true, close: true },
    ffa_hud: { blur: false, radar: true, pause: false, controls: false, close: false, cursor: false },
    gungame_lobby: { blur: true, radar: false, pause: false, controls: true, close: true },
    gungame_hud: { blur: false, radar: true, pause: false, controls: false, close: false, cursor: false },
