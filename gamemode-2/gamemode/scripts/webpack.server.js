...
module.exports = {
    ...
    externals: [
        nodeExternals({
            ...
            // Bundle these so the deployed server doesn't need them in node_modules.
            // typeorm is NOT bundled - it must be in node_modules at runtime (deploy copies it).
            allowlist: ['colorette', 'uuid']
        })
    ],
    plugins: [
